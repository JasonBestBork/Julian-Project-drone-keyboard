...
public class Rule_07_A : Rule_P
{
    ...
    void Update()
    {
        if (Rule_07.NowState == 1 || Rule_07.NowState == 11)
        {
            Rule_07.NowInBox = this.NowInBox;
            DetectClosed();
        }
        if (IsInBoxed && (Rule_07.NowState == 1))
        {
            Rule_07.SwitchBool = true;
            Rule_07.NowState = 2;
            print("From 07_P1 State 1 successed");
            this.Initial();
            Rule_07.Close_All_PPoint();
        }
        if (IsInBoxed && (Rule_07.NowState == 11))
        {
            Rule_07.SwitchBool = true;
            Rule_07.NowState = 12;
            print("From 07_P1 State 11 successed");
            this.Initial();
            Rule_07.Close_All_PPoint();
        }
    }
